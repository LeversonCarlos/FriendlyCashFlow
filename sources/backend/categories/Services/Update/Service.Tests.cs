...
namespace Elesse.Categories.Tests
{
   partial class CategoryServiceTests
   {
      ...
      public async void Update_WithNullParameter_MustReturnBadResult()
      {
         ...
         Assert.Equal(Shared.Results.GetResults("categories", Shared.enResultType.Warning, WARNINGS.INVALID_UPDATE_PARAMETER), (result as Microsoft.AspNetCore.Mvc.BadRequestObjectResult).Value);
      }
      ...
      public async void Update_WithInexistingParentCategory_MustReturnBadRequest()
      {
         ...
         Assert.NotNull(result);
         Assert.IsType<Microsoft.AspNetCore.Mvc.BadRequestObjectResult>(result);
         Assert.Equal(Shared.Results.GetResults("categories", Shared.enResultType.Warning, WARNINGS.PARENT_CATEGORY_NOT_FOUND), (result as Microsoft.AspNetCore.Mvc.BadRequestObjectResult).Value);
      }
      ...
      public async void Update_WithExistingText_MustReturnBadRequest()
      {
         ...
         Assert.NotNull(result);
         Assert.IsType<Microsoft.AspNetCore.Mvc.BadRequestObjectResult>(result);
         Assert.Equal(Shared.Results.GetResults("categories", Shared.enResultType.Warning, WARNINGS.CATEGORY_TEXT_ALREADY_USED), (result as Microsoft.AspNetCore.Mvc.BadRequestObjectResult).Value);
      }
