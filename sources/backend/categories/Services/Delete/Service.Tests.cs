...
namespace Elesse.Categories.Tests
{
   partial class CategoryServiceTests
   {
      ...
      public async void Delete_WithNullParameter_MustReturnBadResult()
      {
         ...
         Assert.Equal(Shared.Results.Message(Shared.enMessageType.Warning, WARNINGS.INVALID_DELETE_PARAMETER), (result as Microsoft.AspNetCore.Mvc.BadRequestObjectResult).Value);
      }
