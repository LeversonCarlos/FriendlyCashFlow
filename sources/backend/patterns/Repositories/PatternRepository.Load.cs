...
namespace Elesse.Patterns
{
   partial class PatternRepository
   {
      ...
      public async Task<IPatternEntity> LoadAsync(Shared.EntityID patternID) =>
         await _Collection
            .Find(entity => entity.PatternID == patternID)
            .SingleOrDefaultAsync();

      public async Task<IPatternEntity> LoadAsync(enPatternType type, Shared.EntityID categoryID, string text) =>
         await _Collection
