...
namespace Elesse.Accounts.Tests
{
   public class AccountEntityTests
   {
      ...
      public static IEnumerable<object[]> Constructor_WithInvalidParameters_MustThrowException_Data() =>
         new[] {
            new object[] { WARNINGS.INVALID_ACCOUNTID, null, "accountText", enAccountType.General, null, null},
            new object[] { WARNINGS.INVALID_TEXT, Shared.EntityID.NewID(), (string)null, enAccountType.General, null, null},
            new object[] { WARNINGS.INVALID_TEXT, Shared.EntityID.NewID(), "", enAccountType.General, null, null},
            new object[] { WARNINGS.INVALID_TEXT, Shared.EntityID.NewID(), " ", enAccountType.General, null, null},
            new object[] { WARNINGS.INVALID_TEXT, Shared.EntityID.NewID(), new string('0', 101), enAccountType.General, null, null},
            new object[] { WARNINGS.INVALID_CLOSING_DAY, Shared.EntityID.NewID(), "accountText", enAccountType.CreditCard, (short)0, null},
            new object[] { WARNINGS.INVALID_CLOSING_DAY, Shared.EntityID.NewID(), "accountText", enAccountType.CreditCard, (short)32, null},
            new object[] { WARNINGS.INVALID_DUE_DAY, Shared.EntityID.NewID(), "accountText", enAccountType.CreditCard, (short)1, (short)0 },
            new object[] { WARNINGS.INVALID_DUE_DAY, Shared.EntityID.NewID(), "accountText", enAccountType.CreditCard, (short)1, (short)32 }
         };
