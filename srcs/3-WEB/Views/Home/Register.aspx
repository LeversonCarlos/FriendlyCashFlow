...
<asp:Content ID="Content1" ContentPlaceHolderID="DrawerContent" runat="server">
   <%= Html.ActionLink("Back", "Login", "Home", new { }, new { @class = "command" })%>
</asp:Content>
   ...
   <div class="main-form">
      ...
      <div class="editor-form">
         ...
         <div class="editor-row editor-row0">
            <div class="editor-label"><%: Html.LabelFor(model => oModel.Description) %></div>
            <div class="editor-validation"><%: Html.ValidationMessageFor(model => oModel.Description, "*")%></div>
            <div class="editor-field"><%: Html.TextBoxFor(model => oModel.Description)%></div>
         </div>
